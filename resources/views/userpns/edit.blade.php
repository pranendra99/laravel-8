...
@section('title', 'Edit User PNS')

@section('content_header')
    <h1 class="m-0 text-dark">Edit User PNS</h1>
@stop

@section('content')
    <form action="{{route('userpns.update', $userpns)}}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="NIP" value="{{ old('nip') }}" name="nip">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kelamin" id="InputJK" class="form-control @error('jenis_kelamin') is-invalid @enderror">
                            <option {{ ($userpns->jenis_kelamin == "L") ? 'selected' : '' }} value="L">Laki-Laki</option>
                            <option {{ ($userpns->jenis_kelamin == "P") ? 'selected' : '' }} value="P">Perempuan</option>
                        </select>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('userpns.index')}}" class="btn btn-default">
                        Batal
                    </a>
                </div>
            </div>
